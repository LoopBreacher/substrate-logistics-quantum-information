...
### Open-System Dynamics, Master Clock Decoherence, and Active $36^\circ$ Chiral Phase Compensation
...
> **Substrate Logistics: The Architecture of Quantum Information**  
> *Deriving the $1.67 \times 10^{-37}\text{ J}$ Erasure Floor, Master Clock Decoherence, and Active $36^\circ$ Chiral Phase Compensation*  
...
### 4. Substrate-Aware Open System Dynamics & $36^\circ$ Chiral Metric Torque
...
| [`The Architecture of Quantum Information.tex`](./The%20Architecture%20of%20Quantum%20Information.tex) | Full LaTeX manuscript source documenting derivations, theorems, and architectural blueprints. |
...
## ⚡ Simulation 2: Active $36^\circ$ Chiral Phase Compensation
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **0** | $0.50000$ | $100.00\%$ | $100.00\%$ | $1.0\times$ | Pure $\vert+\rangle$ state initialization ($0^\circ$) |
| **1** | $0.49924$ | $99.9236\%$ | $99.9236\%$ | $1.0\times$ | Single-gate floor ($\epsilon_{\text{floor}} \approx 7.6371 \times 10^{-4}$) |
| **10** | $0.49242$ | $99.2400\%$ | $99.2400\%$ | $1.0\times$ | $360^\circ$ Full $2\pi$ loop re-alignment |
| **25** | **0.48126** | **1.8700%** | **98.1300%** | **52.5×** | **1st Anti-Phase Node ($900^\circ \equiv 180^\circ$ flip; $\vert+\rangle \to \vert-\rangle$)** |
| **75** | **0.44585** | **5.4100%** | **94.5900%** | **17.5×** | **2nd Anti-Phase Node ($2700^\circ \equiv 180^\circ$ flip)** |
| **100** | $0.42918$ | $92.9200\%$ | $92.9200\%$ | $1.0\times$ | $3600^\circ$ Loop ($10$ full rotations) |
